...
public class Export1 extends Sentences implements Export {
	...
	public static void main(String[] args) {
		Export1 exp1 = new Export1();
		Export2 exp2 = new Export2();
		Export3 exp3 = new Export3();
		exp1.export("VN-INDEX", "12/05/2020");
		exp2.export("VN-INDEX", "12/05/2020");
		exp3.export("VN-INDEX", "12/05/2020");
